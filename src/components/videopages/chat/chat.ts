...
export class ChatPage1 {
	...
	constructor(private sanitizer: DomSanitizer,  private modalCtrl: ModalController, private events: Events, params: NavParams, private chatService: ChatService, private audioService: AudioService) {
