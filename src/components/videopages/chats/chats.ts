...
import { ChatPage1, AccountPage, ContactsPage } from '../';
...
export class ChatsPage {
	constructor(private zone: NgZone, private events:Events, public chatService: ChatService, private navCtrl: NavController) {
	...
	// go to a chat
	chat(id) {
		this.navCtrl.push(ChatPage1, {chatId: id}, {animate: true, direction: 'forward'});
	}
