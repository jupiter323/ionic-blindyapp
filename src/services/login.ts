...
import { LoginPage } from '../components/videopages';
...
export class LoginService {
	...
	constructor( public platform: Platform, app: App, public audio: AudioService, public socket: SocketService, public events: Events, public alertCtrl: AlertController) {
